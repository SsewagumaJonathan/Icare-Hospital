...
<div id="wrapper" class="clearfix">
  ...
  <div class="main-content">
    <!-- Section: home -->
    <section id="home" class="divider parallax fullscreen layer-overlay overlay-dark-9" data-bg-img="images/bg/bg1.jpg">
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-6 col-md-push-3">
                ...
                <form name="login-form" class="form-transparent clearfix" method="post" action="{{ url('/login') }}">
                    @csrf
                  ...
                  <div class="clear text-center pt-10">
                    ...
                    <a class="btn btn-dark btn-lg btn-block no-border" href="{{ url('/register') }}" data-bg-color="#00acee">Register Here</a>
                  </div>
                </form>
  ...
  <!-- Footer -->
  <footer id="footer" class="footer bg-theme-colored">
    <div class="container p-20">
      <div class="row">
        <div class="col-md-12 text-center">
          <p class="mb-0 text-white">Copyright &copy;2016 ThemeMascot. All Rights Reserved</p>
        </div>
      </div>
    </div>
  </footer>
